...
información de posicionamiento del equipo; Registra la información de los pasos de 7 días y el seguimiento del movimiento del equipo.</li>
          </ul>
  ...
  <h2>Idea de solucion</h2>
    <p align="justify">Un sistema compuesto por sensores en el cuerpo de usuario, capaces de medir el movimiento de sus extremidades, y un microcontrolador, capaz de detectar irregularidades, usando los datos recibidos de los sensores, y emitir una notificación alertando sobre riesgo de tener una caida.
</p>
